...
exports.default =  gulp.series(gulp.parallel(copyImg, copyVideo, copyFonts, libsCss, libsJs, mainJs, mainCssDev, htmlDev), gulp.parallel(browser, watcher));
...
exports.production = gulp.series(mainJsBuild, mainCssBuild, compressImg, copySupport, removeModules);
/* End Production */